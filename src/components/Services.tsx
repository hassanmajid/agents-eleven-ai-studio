        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              From simple automation to complex AI systems, we deliver intelligent solutions 
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <Button 
                  variant="outline" 
                  size="sm" 
                  className="w-full border-primary/30 text-primary hover:bg-primary/10 group-hover:border-primary/50 transition-all"
                >
                  Learn More
