      ...
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
            ...
            {/* Centered Heading */}
            <div className="relative z-30 text-center pt-8 pb-16">
              <h3 className={`text-lg font-semibold text-white transition-all duration-700 delay-300 ${
                isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
              }`}>We currently work with:</h3>
            </div>

            {/* Desktop & Tablet Layout - Floating Blocks */}
            <div className="hidden md:block relative z-20 min-h-[600px]">
              {/* Left Side Industries */}
              <div className="absolute left-8 top-24 space-y-3">
                  ...
                  <div 
                    ...
                    style={{ 
                      transform: isVisible && !prefersReducedMotion 
                        ? `translateX(${index * 8}px) translateY(${index * 12}px)` 
                        : prefersReducedMotion 
                          ? `translateX(${index * 8}px) translateY(${index * 12}px)`
                          : `translateX(${index * 8 - 30}px) translateY(${index * 12 - 8}px)`,
            ...
            {/* Button */}
            <div className="hidden md:block relative z-30 text-center pb-8">
              <Button 
                size="lg" 
