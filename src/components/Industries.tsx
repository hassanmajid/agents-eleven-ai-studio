        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <div className="mb-8">
                <p className="text-lg font-semibold text-foreground mb-6">We currently work with:</p>
              ...
              <Button 
                size="lg" 
                className="bg-gradient-to-r from-cyan-400 to-cyan-600 hover:from-cyan-500 hover:to-cyan-700 text-white font-bold px-8 py-4 rounded-full text-lg shadow-lg hover:shadow-xl transition-all duration-300"
              >
                BOOK AN APPOINTMENT
              </Button>
            </div>
